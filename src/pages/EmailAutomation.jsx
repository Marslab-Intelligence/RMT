...
export default function EmailAutomation() {
  ...
  const formatEmailTypeBadge = (type) => {
    switch (type) {
      ...
      case 'renewal_expired': return { label: '⚠️ Expiry Alert', color: 'bg-red-200/90 text-[#450a0a] border-red-400 dark:bg-red-200/90 dark:text-[#450a0a] dark:border-red-400 font-extrabold' };
      case 'automation_toggle': return { label: '⚙️ Automation Toggle', color: 'bg-slate-200/90 text-black border-slate-400 dark:bg-slate-200/90 dark:text-black dark:border-slate-400 font-extrabold' };
